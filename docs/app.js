const I18N = {
  en: {
    navFeatures:'Features', navPrivacy:'Privacy', navFaq:'FAQ',
    heroTitle:'Find out who does not follow you back on Instagram.', heroText:'Analyze your account, filter results, export data, and decide exactly which accounts to keep before unfollowing.', download:'Add to Chrome', github:'View on GitHub',
  ...
  es: {
    navFeatures:'Funciones', navPrivacy:'Privacidad', navFaq:'FAQ', eyebrow:'Extensión de Chrome · Utilidad para Instagram',
    heroTitle:'Descubre quién no te sigue de vuelta en Instagram.', heroText:'Analiza tu cuenta, filtra resultados, exporta datos y decide exactamente qué cuentas conservar antes de dejar de seguir.', download:'Agregar a Chrome', github:'Ver en GitHub',

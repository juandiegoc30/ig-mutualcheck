const I18N = {
  ...
  es: {
    ...
    previewAccount:'Cuenta: @demo.user', previewAnalyze:'Analizar cuenta', previewCancel:'Cancelar', previewCopy:'Copiar lista', previewExport:'Exportar', previewStatus:'Análisis terminado. 12 cuentas no te siguen de vuelta.', previewFollowers:'Seguidores', previewFollowing:'Seguidos', previewNotFollowing:'No te siguen', previewContains:'Contiene', previewAll:'Todas', previewShowing:'Mostrando 2 de 12 resultados', previewClear:'Limpiar filtro', previewSelectAll:'Seleccionar todo', previewSelected:'12 de 12 seleccionadas', previewSpeed:'Velocidad para dejar de seguir', previewBalanced:'Equilibrada', previewBalancedHint:'5 a 8 s por cuenta', previewFast:'Rápida', previewFastHint:'2.5 a 4.5 s por cuenta', previewUnfollow:'Dejar de seguir seleccionadas', previewDetected:'Cuentas detectadas', previewSmallSelected:'12 seleccionadas', previewOpen:'Abrir', previewFooter:'La extensión usa tu sesión activa de Instagram desde el navegador. No solicita contraseña ni almacena credenciales.',
...
function applyLang(nextLang) {
  ...
  if (langFlag) langFlag.className = 'fi fi-' + (lang === 'es' ? 'es' : 'us');
